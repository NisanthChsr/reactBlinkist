...
import { fireEvent, render, cleanup, queryByTestId, screen, wait,waitFor, getByPlaceholderText, querySelector, getAllByPlaceholderText, getByTestId, findByText } from '@testing-library/react';
...
describe("Test for Library", () => {
    ...
    it("Library", async () => {
        ...
        //await (() => expect(screen.getByText('+Add to library')).toBeNull());
    });
